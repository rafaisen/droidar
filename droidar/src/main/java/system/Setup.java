...
import static v2.simpleUi.util.ErrorHandler.DATA_ANDROID_MIME_TYPE;
import static v2.simpleUi.util.ErrorHandler.registerNewErrorHandler;
...
public abstract class Setup {
    ...
    /*
     *  Default orientation is landscape mode for 90 degree rotation
     */
    //private static Integer screenOrientation = Surface.ROTATION_90;
    private static Integer screenOrientation = Surface.ROTATION_0;
    ...
    /**
     * By overriding this (and not calling the super method) the
     * {@link v2.simpleUi.util.ErrorHandler} system provided by DroidAR will be deactivated (e.g.
     * while debugging)
     */
    public void initializeErrorHandler() {
        debugLogDoSetupStep(STEP1);
        registerNewErrorHandler(getActivity(), DATA_ANDROID_MIME_TYPE);
    }
